...
private:
	...
	static void _SetVelocitiesAfterCollisionResolution(float aX, float aY, float& aVelX, float& aVelY, float aRadius, float bX, float bY, float& bVelX, float& bVelY, float bRadius);
